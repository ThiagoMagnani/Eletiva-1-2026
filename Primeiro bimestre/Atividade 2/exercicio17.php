...
<body>
    <div class="container py-3">
        ...
        <form method="post">
            <div class="mb-3">
                <label for="num1" class="form-label">Insira o capital</label>
                <input type="text" id="num1" name="num1" class="form-control" required="">
            </div>
            <div class="mb-3">
                <label for="num2" class="form-label">Inserir a taxa</label>
                <input type="text" id="num2" name="num2" class="form-control" required="">
            </div>
            <div class="mb-3">
                <label for="num3" class="form-label">Inserir o periodo</label>
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            $valor2 = $_POST['num2'];
            $valor3 = $_POST['num3'];
            $montante = $valor1 + ($valor1 * $valor2 * $valor3);
